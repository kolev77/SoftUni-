...
@NamedQueries({
//Problem 21. Delete ingredients by name
        @NamedQuery(name = "BasicIngredient.deleteByName", query = "DELETE FROM BasicIngredient WHERE name = :name"),

//Problem 22. Update price by 10%
        @NamedQuery(name = "BasicIngredient.updatePrice", query = "UPDATE BasicIngredient AS bi SET bi.price = bi.price *1.10")
})
