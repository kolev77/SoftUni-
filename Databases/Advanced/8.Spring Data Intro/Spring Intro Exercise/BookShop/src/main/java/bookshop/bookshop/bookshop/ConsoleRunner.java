package bookshop.bookshop.bookshop;

import bookshop.bookshop.bookshop.model.*;
...
public class ConsoleRunner implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
     ...
     // Problem 1
//        String ageRestrictionType = br.readLine();
//        AgeRestriction ageRestriction1 = AgeRestriction.valueOf(ageRestrictionType.toUpperCase());
//
//        List<Book> books = this.bookService.findAllByAgeRestriction(ageRestriction1);
//
//        for (Book book : books) {
...
//        }
        ...
        // problem 2
//        String startsWith = br.readLine();
//        Set<Author> allAuthorsByFirstNameStartingWith = authorService.findAllByFirstNameStartingWith(startsWith);
//
//        for (Author author : allAuthorsByFirstNameStartingWith) {
//            System.out.println(author.getFirstName() + " " + author.getLastName());
//        }

        // problem 10
//        Integer len = Integer.parseInt(br.readLine());
//        System.out.println(this.bookService.getCountByTitleLength(len));

        // PROBLEM 15

//        String date = br.readLine();
//        Integer copies = Integer.parseInt(br.readLine());
//        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd MMM yyyy");
//        Date givenDate = simpleDateFormat.parse(date);
//        Integer updatedRows = this.bookService.updateBookCopiesAfterDate(copies, givenDate);
...
//        int copiesCount = Integer.parseInt(br.readLine());
