function calendar([day, month, year]) {
    ...
    let firstDay = (new Date(year, month - 1, 1).getDay() - 1);  // return the last day of previous month
    ...
    let lastDay = new Date(year, month, 0).getDate(); // return the last day of current month
