...
public final class WebConstants {
    ...
    public static final Integer DEFAULT_SERVER_PORT = 8003;

    public static final String WEB_SERVER_HTTP_VERSION = "HTTP/1.1";

    public static final String SERVER_SESSION_TOKEN = "Javache";

    public static final String WEB_SERVER_ROOT_FOLDER_PATH = Server.class.getResource("")
            .getPath()
            .replace(WEB_SERVER_PACKAGE_FOLDER_PATH,
                    "")
            .substring(1);

    public static final String WEB_SERVER_STATIC_FOLDER_PATH = WEB_SERVER_ROOT_FOLDER_PATH+"static";
